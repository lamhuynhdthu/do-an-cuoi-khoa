...
%     lblDataTrain = imdsDataTrain.Labels;
    ...
    M = load('datatrainalexnet.mat');
    featuresDataTrain = M.featuresDataTrain;
    lblDataTrain = M.lblDataTrain;
...
%     featuresDataTest = activations(net,imdsDataTest,featureLayer,'MiniBatchSize',32);
    T = load('datatestalexnet.mat');
    featuresDataTest = T.featuresDataTest;
    lblActualDataTest = T.lblActualDataTest;
